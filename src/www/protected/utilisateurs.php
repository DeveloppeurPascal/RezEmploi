...
function getMotDePasseChiffre($password, $key): string
{
...
function validation_utilisateur($email, $key): bool
{
    global $db;
...
function isUtilisateurConnecte(): bool
{
...
function connexion_utilisateur($utilisateur): bool
{
